...
function FeaturedPlanzy() {
  ...
  const details = t("featuredPlanzy.details", { returnObjects: true });

  return (
    <section className="featured-planzy">
      <div className="container">
        <div className="featured-planzy__grid">
          <Reveal>
        ...
        <div className="featured-planzy__details">
          {details.map((item, index) => (
            <Reveal key={item.title} delay={index * 0.06}>
              <article className="featured-planzy__detail-card">
